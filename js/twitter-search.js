$(document).ready(function(){
    ...
    function channelSearch(search) {
        fetch("https://api.subscriberwars.space/twitter/user-search/5/" + search).then(res => res.json()).then(data => {
           ...
           link1.href = "https://subscriberwars.space/twitter/followers?u="+data[0].screen_name
           ...
           link2.href = "https://subscriberwars.space/twitter/followers?u="+data[1].screen_name
           ...
           link3.href = "https://subscriberwars.space/twitter/followers?u="+data[2].screen_name
           ...
           link4.href = "https://subscriberwars.space/twitter/followers?u="+data[3].screen_name
           ...
           link5.href = "https://subscriberwars.space/twitter/followers?u="+data[4].screen_name
        })
    }
})